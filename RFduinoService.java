...
public class RFduinoService extends Service {
    private final static String TAG = "WiSPR";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                Log.i("WiSPR", "Connected to WiSPR.");
                Log.i("WiSPR", "Attempting to start service discovery:" +
                        mBluetoothGatt.discoverServices());
            } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                Log.i("WiSPR", "Disconnected from WiSPR.");
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                if (mBluetoothGattService == null) {
                    Log.e("WiSPR", "RFduino GATT service not found!");
                    return;
                }
                ...
                if (receiveCharacteristic != null) {
                    ...
                    if (receiveConfigDescriptor != null) {
                        ...
                        Log.e("WiSPR", "RFduino receive config descriptor not found!");
                    }

                } else {
                    Log.e("WiSPR", "RFduino receive characteristic not found!");
                }

                broadcastUpdate(ACTION_CONNECTED);
            } else {
                Log.w("WiSPR", "onServicesDiscovered received: " + status);
            }
        }
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                Log.e("WiSPR", "Unable to initialize BluetoothManager.");
                return false;
            }
        }
        ...
        if (mBluetoothAdapter == null) {
            Log.e("WiSPR", "Unable to obtain a BluetoothAdapter.");
            return false;
        }
    ...
    public boolean connect(final String address) {
        if (mBluetoothAdapter == null || address == null) {
            Log.w("WiSPR", "BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
        ...
        if (mBluetoothDeviceAddress != null && address.equals(mBluetoothDeviceAddress)
                && mBluetoothGatt != null) {
            Log.d("WiSPR", "Trying to use an existing mBluetoothGatt for connection.");
        ...
        Log.d("WiSPR", "Trying to create a new connection.");
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w("WiSPR", "BluetoothAdapter not initialized");
            return;
        }
    ...
    public void read() {
        if (mBluetoothGatt == null || mBluetoothGattService == null) {
            Log.w("WiSPR", "BluetoothGatt not initialized");
            return;
        }
    ...
    public boolean send(byte[] data) {
        ...
        if (characteristic == null) {
            Log.w("WiSPR", "Send characteristic not found");
            return false;
        }

        Log.d("WiSPR", "Sending data");
